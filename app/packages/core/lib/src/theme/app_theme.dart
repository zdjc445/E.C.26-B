...
/// Shared product theme for the Flutter workspace.
...
/// Convenience accessors for common colors — usable in widgets that need
/// one-off color values outside the theme.
class AppColors {
